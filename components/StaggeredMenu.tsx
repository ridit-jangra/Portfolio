...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div
      className={`sm-scope z-40 ${isFixed ? "fixed top-0 right-0 w-[45vh] h-screen overflow-hidden" : "w-full h-full"}`}
    >
      <div
        className={
          (className ? className + " " : "") +
      ...
      >
        ...
        >
          ...
          >
            <span
              ref={textWrapRef}
              className="sm-toggle-textWrap relative text-black inline-block h-[1em] overflow-hidden whitespace-nowrap w-[var(--sm-toggle-width,auto)] min-w-[var(--sm-toggle-width,auto)]"
              aria-hidden="true"
            >
              <span
                ref={textInnerRef}
            ...
            <span
              ref={iconRef}
              className="sm-icon relative w-[14px] h-[14px] text-black shrink-0 inline-flex items-center justify-center [will-change:transform]"
              aria-hidden="true"
            >
              <span
                ref={plusHRef}
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: oklch(78.5% 0.115 274.713); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
