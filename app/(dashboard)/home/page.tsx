    ...
    <div className="h-screen flex flex-col w-full">
      <section className="min-h-screen flex items-center justify-center relative bg-[#F6AB00] overflow-hidden px-4">
        ...
        <div className="text-center relative">
          ...
          <p className="text-7xl relative sm:text-9xl md:text-[15rem] lg:text-[20rem] xl:text-[25rem] font-employed select-none drop-shadow-2xl">
            Ridit
            <p className="absolute top-10 -right-10 text-5xl">(15)</p>
          </p>
      ...
      {/* <section className="min-h-screen flex items-center justify-center relative bg-[#feebdb] overflow-hidden px-4 ">
        <div
          className="absolute w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full opacity-30 blur-3xl"
          style={{
            background: "#8B7BA8",
        ...
        <p className="text-7xl relative sm:text-9xl md:text-[15rem] lg:text-[20rem] xl:text-[25rem] font-employed select-none drop-shadow-2xl">
          about
          <p className="absolute top-10 -right-10 text-5xl">me</p>
        </p>
      </section> */}
    </div>
  );
