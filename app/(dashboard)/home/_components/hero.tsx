...
export function Hero() {
  ...
  return (
    ...
    >
      <div className="absolute z-10 flex flex-col bottom-0">
        <p className="text-[2rem] font-inter px-7 py-0 m-0 mb-16 bg-linear-to-r from-gray-700 via-yellow-600/60 to-yellow-300/20 bg-clip-text text-transparent drop-shadow-[0_0_12px_rgba(255,230,0,0.4)]">
          Howdy! I am Ridit
          <br /> Btw i am{" "}
          <CountUp
            from={0}
          ...
          />{" "}
          How about you?
          <span className="relative ml-1 w-min">
            <input
              type="text"
              name="_"
              value={age ?? ""}
        ...
        <motion.p
          ...
          className="text-[21.98rem] font-sinteca select-none drop-shadow-2xl m-0 leading-none"
        >
          Ridit Jangra
        </motion.p>
      </div>
